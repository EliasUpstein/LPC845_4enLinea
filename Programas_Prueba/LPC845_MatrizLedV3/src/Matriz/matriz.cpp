...
//		if((CTIMER0->TC < MARGEN_TICKS_MENOR) && (ticks_ant > MARGEN_TICKS_MAYOR))
		//Si la cantidad de ticks anteriores es mayor que la cantidad de ticks actuales significa que hubo un reset en el medio
//		if(ticks_ant > CTIMER0->TC)
		//Si la cantidad de ticks actual es mayor al valor del match menos el margen
		if(CTIMER0->TC > (CTIMER0->MR[0] - MARGEN_TICKS))
		{
