...
CPP_SRCS += \
../src/Modulos/03-callback/callback.cpp 

CPP_DEPS += \
./src/Modulos/03-callback/callback.d 

OBJS += \
./src/Modulos/03-callback/callback.o 


# Each subdirectory must supply rules for building sources it contributes
src/Modulos/03-callback/%.o: ../src/Modulos/03-callback/%.cpp src/Modulos/03-callback/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-src-2f-Modulos-2f-03-2d-callback

clean-src-2f-Modulos-2f-03-2d-callback:
	-$(RM) ./src/Modulos/03-callback/callback.d ./src/Modulos/03-callback/callback.o

.PHONY: clean-src-2f-Modulos-2f-03-2d-callback
